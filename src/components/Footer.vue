<template>
  ...
  <div class="max-w-7xl mx-auto px-6 py-10">
    ...
    <!-- Top Navigation -->
    <div class="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-7 gap-6 border-b border-white/20 pb-8">
      ...
      <div>
        ...
        <ul class="space-y-1 text-sm text-[#333333]">
          ...
          <li><a href="#" class="hover:text-white transition">Space + Science</a></li>
        </ul>
      </div>
      ...
      <div>
        ...
        <ul class="space-y-1 text-sm text-[#333333]">
          ...
          <li><a href="#" class="hover:text-white transition">Europe</a></li>
          <li><a href="#" class="hover:text-white transition">Middle East</a></li>
        </ul>
      </div>
      ...
      <div>
        ...
        <ul class="space-y-1 text-sm text-[#333333]">
          ...
          <li><a href="#" class="hover:text-white transition">Primary Results</a></li>
        </ul>
      </div>
      ...
      <div>
        ...
        <ul class="space-y-1 text-sm text-[#333333]">
          ...
          <li><a href="#" class="hover:text-white transition">Success</a></li>
        </ul>
      </div>
    ...
    <!-- Bottom Navigation -->
    <div class="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-7 gap-6 pt-8">
