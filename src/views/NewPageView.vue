<template>
<body class="bg-[#e9ecef] text-gray-300">
...
<ul class="space-y-4">
<li>
<p class="text-gray-300">Monsoon Forecast in Southeast Asia</p>
<span class="text-sky-400 font-semibold">8.9</span>
<span class="text-gray-500 text-sm">(1,245 rates)</span>
</li>

<li>
<p class="text-gray-300">Heatwave Impact Across South Asia</p>
<span class="text-sky-400 font-semibold">8.6</span>
<span class="text-gray-500 text-sm">(982 rates)</span>
</li>

<li>
<p class="text-gray-300">Typhoon Tracking in East Asia</p>
<span class="text-sky-400 font-semibold">9.1</span>
<span class="text-gray-500 text-sm">(1,430 rates)</span>
</li>
</ul>
</div>
